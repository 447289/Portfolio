...
export const ABOUT_TEXT = `I am a dedicated and versatile  Frontened developer with a passion for creating efficient and user-friendly web applications. With 4 months of hands-on experience, I have developed skills in front-end technologies including HTML, CSS, JavaScript, and React. My journey in web development began with a deep curiosity for how things work and has quickly evolved into a commitment to learning and adapting to new challenges. I thrive in collaborative environments and enjoy solving complex problems to deliver high-quality solutions. Outside of coding, I stay active, explore new technologies, and contribute to open-source projects.`;
...
export const EXPERIENCES = [
  {
    ...
    // company: "Google Inc.",
    description: `Led a team in developing and maintaining web applications using JavaScript, React.js.Collaborated with stakeholders to define project requirements and establish timelines.`,
